    ...
    return (            
        <div className="simulator-container">
            ...
            <div className="disclaimer">
                ...
                <p>Este simulador muestra una pequeña parte de la diversidad auditiva. Cada persona es un caso.</p>
                <p>Si quieres saber más visita las <a href="/buenas-practicas">BUENAS PRÁCTICAS</a></p>
            </div>
        </div>
    );
}
